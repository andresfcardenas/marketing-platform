...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'store_category', 'image',
                      self.gf('django.db.models.fields.files.ImageField')(default='img/logo_default.png', max_length=100, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Category.image'
        db.delete_column(u'store_category', 'image')
