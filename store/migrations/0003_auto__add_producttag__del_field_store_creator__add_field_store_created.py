...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'store_producttag', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('parent', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['store.ProductTag'], null=True, blank=True)),
            ('slug', self.gf('autoslug.fields.AutoSlugField')(unique=True, max_length=50, populate_from='name', unique_with=())),
        ))
        db.send_create_signal(u'store', ['ProductTag'])

        # Deleting field 'Store.creator'
        db.delete_column(u'store_store', 'creator_id')

        # Adding field 'Store.created_by'
        db.add_column(u'store_store', 'created_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True),
                      keep_default=False)

        # Adding field 'Product.created_by'
        db.add_column(u'store_product', 'created_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True),
                      keep_default=False)

        # Adding M2M table for field tags on 'Product'
        m2m_table_name = db.shorten_name(u'store_product_tags')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('product', models.ForeignKey(orm[u'store.product'], null=False)),
            ('producttag', models.ForeignKey(orm[u'store.producttag'], null=False))
        ))
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'store_producttag')

        # Adding field 'Store.creator'
        db.add_column(u'store_store', 'creator',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True),
                      keep_default=False)

        # Deleting field 'Store.created_by'
        db.delete_column(u'store_store', 'created_by_id')

        # Deleting field 'Product.created_by'
        db.delete_column(u'store_product', 'created_by_id')

        # Removing M2M table for field tags on 'Product'
        db.delete_table(db.shorten_name(u'store_product_tags'))
    ...
    models = {
        ...
        u'store.product': {
            ...
            'tags': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['store.ProductTag']", 'symmetrical': 'False'})
        },
        u'store.producttag': {
            'Meta': {'object_name': 'ProductTag'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['store.ProductTag']", 'null': 'True', 'blank': 'True'}),
